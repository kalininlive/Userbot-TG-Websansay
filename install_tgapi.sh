...
# Загружаем server.js напрямую из репозитория
curl -fsSL https://raw.githubusercontent.com/Websansay/Userbot-TG-Websansay/main/src/server.js \
  -o /opt/tgapi/src/server.js
...
log "Wizard: http://127.0.0.1:3000/auth/qr/wizard (используй API_TOKEN)"
